...
`work/systemd-unit-tracking/LOG.md`.

Merged via [PR #1](https://github.com/botverse/tgcc/pull/1), merge commit
`f96fb0768c529ac71b576ac1e702320386a3514c`, 2026-09-15T11:49:33Z. What this confirms:
the unit is tracked in Git and the live symlink resolves into the repo, and the running
service was not restarted by this change (`MainPID` 549257 / `NRestarts` 2435 unchanged
throughout, re-verified after merge). This is not a deployment or restart-tested claim
beyond that — the service has not been restarted against the symlinked unit since this
landed.
